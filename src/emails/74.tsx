...
interface EventFlagRevokedEmailProps {
    user: User;
    event: Event;
}

const EventFlagRevokedEmail = ({ user, event }: EventFlagRevokedEmailProps) => (
    <Html>
        <Head />
        <Body
            style={{
        ...
        >
            ...
            >
                ...
                <Text style={{ color: '#333', fontSize: '24px' }}>✅ Event Flag Revoked</Text>
                <Text style={{ marginBottom: '20px' }}>Hello {user.name},</Text>
                <Text style={{ marginBottom: '20px' }}>
                    We are pleased to inform you that the flag on your event has been reviewed and
                    revoked. Your event complies with our community guidelines.
                </Text>
                ...
                >
                    <Text style={{ color: '#333', fontSize: '16px' }}>Revoked Event:</Text>
...
export default EventFlagRevokedEmail;
