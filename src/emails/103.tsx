...
interface FlaggedOpeningDeletedEmailProps {
    user: User;
    opening: Opening;
}

const FlaggedOpeningDeletedEmail = ({ user, opening }: FlaggedOpeningDeletedEmailProps) => (
    <Html>
        <Head />
        <Body
            style={{
        ...
        >
            ...
            >
                ...
                <Text style={{ color: '#333', fontSize: '24px' }}>🚩 Opening Deleted</Text>
                <Text style={{ marginBottom: '20px' }}>Hello {user.name},</Text>
                <Text style={{ marginBottom: '20px' }}>
                    We wanted to inform you that your opening has been reviewed and deleted for
                ...
                >
                    <Text style={{ color: '#333', fontSize: '16px' }}>Deleted Opening:</Text>
                ...
                <Text style={{ marginBottom: '20px' }}>
                    Please ensure that future openings adhere to our community guidelines to avoid
                    further actions.
                </Text>
                <Text style={{ marginBottom: '20px' }}>
...
export default FlaggedOpeningDeletedEmail;
