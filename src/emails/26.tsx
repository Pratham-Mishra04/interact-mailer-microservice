...
interface EventAttentionEmailProps {
    user: User;
    event: Event;
}
export default function EventAttentionEmail({ user, event }: EventAttentionEmailProps) {
    return (
        <Html>
            <Head />
            <Body
            ...
            >
                ...
                >
                    ...
                    >
                        Your Event is Getting Attention!
                    </Text>
                    ...
                    >
                        <strong>Your event got {event.noImpressions} impressions.</strong>
                    </Text>
