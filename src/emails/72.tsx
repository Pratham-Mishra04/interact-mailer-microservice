...
interface ProjectFlagRevokedEmailProps {
    user: User;
    project: Project;
}
const ProjectFlagRevokedEmail = ({ user, project }: ProjectFlagRevokedEmailProps) => (
    <Html>
        <Head />
        <Body
            style={{
        ...
        >
            ...
            >
                ...
                <Text style={{ color: '#333', fontSize: '24px' }}>✅ Project Flag Revoked</Text>
                <Text style={{ marginBottom: '20px' }}>Hello {user.name},</Text>
                <Text style={{ marginBottom: '20px' }}>
                    We are pleased to inform you that the flag on your project has been reviewed and
                    revoked. Your project complies with our community guidelines.
                </Text>
                ...
                >
                    <Text style={{ color: '#333', fontSize: '16px' }}>Revoked Project:</Text>
                    <Text style={{ fontStyle: 'italic', color: '#555' }}>"{project.title}"</Text>
                </div>
...
export default ProjectFlagRevokedEmail;
