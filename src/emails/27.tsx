...
interface OpeningAttentionEmailProps {
    user: User;
    opening: Opening;
}
export default function OpeningAttentionEmail({ user, opening }: OpeningAttentionEmailProps) {
    return (
        <Html>
            <Head />
            <Body
            ...
            >
                ...
                >
                    ...
                    >
                        Your Opening is Getting Attention!
                    </Text>
                    ...
                    >
                        <strong>Your opening got {opening.noImpressions} impressions.</strong>
                    </Text>
