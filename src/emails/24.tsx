...
interface MeetingRescheduledEmailProps {
    user: User;
    meeting: Meeting;
}

export default function MeetingRescheduledEmail({ user, meeting }: MeetingRescheduledEmailProps) {
    return (
        <Html>
            <Head />
            <Body
            ...
            >
                ...
                >
                    ...
                    >
                        We are writing to inform you that the meeting has been rescheduled. Please
                        find the updated meeting details below:
                    </Text>
                    ...
                    >
                        Please ensure that you join the meeting at the new scheduled time. You can
                        view and manage this meeting by logging into your Interact account or you
                        can directly go to the meeting page by clicking on the button below!
                    </Text>
