...
interface PollFlagRevokedEmailProps {
    user: User;
    poll: Poll;
}
const PollFlagRevokedEmail = ({ user, poll }: PollFlagRevokedEmailProps) => (
    <Html>
        <Head />
        <Body
            style={{
        ...
        >
            ...
            >
                ...
                <Text style={{ color: '#333', fontSize: '24px' }}>✅ Poll Flag Revoked</Text>
                <Text style={{ marginBottom: '20px' }}>Hello {user.name},</Text>
                <Text style={{ marginBottom: '20px' }}>
                    We are pleased to inform you that the flag on your poll has been reviewed and
                    revoked. Your poll complies with our community guidelines.
                </Text>
                ...
                >
                    <Text style={{ color: '#333', fontSize: '16px' }}>Revoked Poll:</Text>
...
export default PollFlagRevokedEmail;
